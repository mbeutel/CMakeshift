    ...
    elseif(SETTING STREQUAL "default-triplet")
        ...
        if(MSVC AND VCPKG_CRT_LINKAGE)
            ...
            if(CMAKE_CUDA_FLAGS_DEBUG MATCHES "/M(D|T)d")
                string(REGEX REPLACE "/M(D|T)d" "/M${_CRT_FLAG}d" CMAKE_CUDA_FLAGS_DEBUG_NEW "${CMAKE_CUDA_FLAGS_DEBUG}") # TODO: is this done right, with the quoted string in CMAKE_CUDA_FLAGS_*?
            ...
            if(CMAKE_CUDA_FLAGS_RELEASE MATCHES "/M(D|T)")
                string(REGEX REPLACE "/M(D|T)" "/M${_CRT_FLAG}" CMAKE_CUDA_FLAGS_RELEASE_NEW "${CMAKE_CUDA_FLAGS_RELEASE}") # TODO: is this done right, with the quoted string in CMAKE_CUDA_FLAGS_*?
